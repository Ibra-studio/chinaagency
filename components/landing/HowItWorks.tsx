...
import { LabelSection } from "../ui/section-label";
  ...
  const defaultFeatures: Step[] = [
    {
      ...
      description:
        "Échangez avec notre équipe pour définir votre projet d'études : domaine, ville, budget et objectifs.",
      colorTheme: "orange",
    },
    {
      title: "Choix du programme",
      description:
        "Nous sélectionnons avec vous les universités et filières adaptées à votre profil parmi nos 30 écoles partenaires.",
      colorTheme: "blue",
    },
    {
      title: "Constitution du dossier",
      description:
        "Upload de vos documents (diplômes, passeport, relevés) sur votre espace personnel et vérification par notre équipe.",
      colorTheme: "purple",
    },
    {
      title: "Admission & visa",
      description:
        "Nous gérons le suivi de votre admission et vous accompagnons dans toute la procédure de visa étudiant.",
      colorTheme: "orange",
    },
    {
      title: "Départ & suivi",
      description:
        "Préparation au départ, logement, et suivi personnalisé une fois sur place en Chine.",
      colorTheme: "blue",
    },
  ];
